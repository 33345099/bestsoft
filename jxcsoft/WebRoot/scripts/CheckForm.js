...
function CheckObject(form, obj) {
	...
	if (typeof obj.className != "undefined") {
		var temps = obj.className.split(PARMASSPLITKEY);
...
function check8(tag8, form, obj, value) {
	...
	return (value
			.search('^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$') != -1);
}
...
function check11(tag11, form, obj, value) {
	...
	return (value.search(/^((\(\d{3}\))|(\d{3}\-))?13\d{9}|15[123456789]\d{8}$/) != -1);
}
...
AddCheckFunctionObject(tag14, "", check14, null);
